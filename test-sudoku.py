...
class TestSudokuSolver(unittest.TestCase):
    ...
    def test_invalid_board(self):
        # Board with duplicate numbers in a row
        invalid_puzzle = [
            [5, 5, 0, 0, 7, 0, 0, 0, 0],
            [6, 0, 0, 1, 9, 5, 0, 0, 0],
            [0, 9, 8, 0, 0, 0, 0, 6, 0],
        ...
        self.assertIsNone(sudoku_solver(invalid_puzzle))

    def test_unsolvable_board(self):
        # Board thats valid but has no solution
        unsolvable_puzzle = [
            [5, 1, 6, 8, 4, 9, 7, 3, 2],
            [3, 0, 7, 6, 0, 5, 0, 0, 0],
            [8, 0, 9, 7, 0, 0, 0, 6, 5],
        ...
        self.assertIsNone(sudoku_solver(unsolvable_puzzle))

    def test_invalid_dimensions(self):
        # Board with incorrect dimensions
        invalid_puzzle = [
